...
void PreLiquidacion::cargar(){
    ...
    locate(53,5);cin>>feriados; ///TODO FERIADOS DEBERIA VALIDARSE CON ENTEROS NO CON PALABRAS
    locate(64,5);cin>>aux;
    ...
    if(validarTexto(aux)==2){setPuntualidad(0);}
    else{setPresentismo(1);}
...
int validarTexto(const char *rt){
    if(strcmp(rt,"si")==0 || strcmp(rt,"SI")==0)return 1;
    else if(strcmp(rt,"no")==0 || strcmp(rt,"NO")==0){return 2;}
    else{return -1;}
}
