...
void Empleado::cargar(){
    ...
    fechaIngreso.cargar(); ///HABRÍA QUE PODER CALCULAR SI LA PERSONA FUE MAYOR DE EDAD AL MOMENTO DE REGISTRARLA
    /*mayorDeEdad=false;
    while(mayorDeEdad==false){
    ...
    cout<<"FECHA DE INGRESO: ";
    fechaIngreso.cargar();
    while(CalcularEdad(fechaIngreso)<18){
       cout<<"FECHA DE INGRESO NO VALIDA"<<endl;
       }
    }
