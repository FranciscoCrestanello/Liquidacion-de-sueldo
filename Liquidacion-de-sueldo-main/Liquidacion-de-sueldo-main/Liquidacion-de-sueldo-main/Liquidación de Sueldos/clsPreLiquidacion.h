...
class PreLiquidacion{
	...
	public:
        //sets
         void setDni(int x){
            while(!validacionDni(x)){
                locate(30,13);cout<<"El DNI NO EXISTE EN EL SISTEMA"<<endl;
                locate(30,14);cout<<"INGRESE OTRO NUMERO: ";
                cin>>x;
            }
            dni=x;
        }
        void setFeriados(int x){
            while(x<0){
                locate(35,13);cout<<"EL NUMERO DEBE SER MAYOR O IGUAL A 0: "<<endl;
                locate(36,14);cout<<"INGRESE OTRO NUMERO: ";
                cin>>x;
            }
            feriados=x;
        }
        void setHorasTrabajadas(float x){
            while( !(x>0 && x<201) ){
                ...
                locate(36,14);cout<<"INGRESE LA CANTIDAD DE HORAS NUEVAMENTE: ";
                cin>>x;
            }
            horasTrabajadas=x;}
...
void PreLiquidacion::cargar(){
    ...
    locate(22,5);cin>>dni;
    while(validacionDni(dni)==false){
        locate(30,13);cout<<"El DNI NO EXISTE EN EL SISTEMA";
        locate(22,5);cout<<"    ";
        locate(22,5);cin>>dni;
    }
    locate(30,13);cout<<"                               ";
