...
int main(){
    int POSMENUX=35,POSMENUY=8, ANCHO_MENU=30,ALTO_MENU=9;
    ...
    while(opc!=0){
        ...
        separadorH(POSMENUX,POSMENUY+7,ANCHO_MENU,LETRA_COLOR,FONDO_COLOR);
        locate(POSMENUX+4,POSMENUY+8);
        cout<<" SALIR DEL PROGRAMA"<<endl;

        opc=mostrarCursor(cursorX,cursorY,opc,POSMENUY,4,8);
